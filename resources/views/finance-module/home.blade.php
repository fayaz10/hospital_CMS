            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        <strong>{{__('finance.incExpGraph')}}</strong>
                    </h3>
                </div>
            </div>
        </div>
            ...
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <strong>{{__('finance.incGraph')}}</strong>
                            </h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <strong>{{__('finance.expGraph')}}</strong>
                            </h3>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $.ajax({
            url: "{{ route('finance.in-ex-graph', ['sub' => 3]) }}",
            dataType: 'json',
            type: "get",
        ...
        $.ajax({
            url: "{{ route('finance.income-graph', ['sub' => 1]) }}",
            dataType: 'json',
            type: "get",
            success: function(response) {
    ...
    function loadChart(months, incomeData, expenseData) {
        var config = {
            ...
            data: {
                labels: months,
                datasets: [{
                    label: '{{__("finance.incomes")}}',
                    backgroundColor: '#8527B7',
                    borderColor: '#8527B7',
                    data: incomeData,
                    fill: true,
                }, {
                    label: '{{__("finance.expenses")}}',
            ...
            options: {
                ...
                scales: {
                    xAxes: [{
                        ...
                        scaleLabel: {
                            display: true,
                            labelString: '{{__("reception.months")}}'
                        }
                    }],
                    yAxes: [{
                        display: true,
                        scaleLabel: {
                            display: true,
                            labelString: '{{__("reception.values")}}'
                        }
                    }]
                }
            }
