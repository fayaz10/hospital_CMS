    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">{{__('global.create')}}</span>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('diverse-expense.store') }}" id="save-form" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                {{ csrf_field() }}
                <!--begin: Form Body -->
                <div class="m-portlet__body">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <input type="text" name="reason" required class="form-control m-input" value="{{ old('reason') }}" placeholder="">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6 m-form__group-sub">
                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <input type="date" name="payment_date" required class="form-control m-input" value="{{ old('payment_date', date('Y-m-d')) }}" placeholder="">
                                </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <input type="number" name="amount" required class="form-control m-input" value="{{ old('amount') }}" placeholder="">
                                </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-12 m-form__group-sub">
                                    ...
                                    <input type="text" name="remitter" required class="form-control m-input" value="{{ old('remitter', auth()->user()->name_dr) }}" placeholder="">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
