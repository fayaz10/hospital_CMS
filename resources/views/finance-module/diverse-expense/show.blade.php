                ...
                <div class="row">
                    <div class="col-xl-10 offset-xl-1 col-md-10 offset-md-1">
                        ...
                        <div class="m-form__heading mt-3">
                            <h2 class="m-form__heading-title">{{__('finance.eInfoNewDiverIncome')}}</h2>
                        </div>
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 m-form__group-sub">
                                ...
                                {{__('finance.dCategory')}}</label>
                                    <p><strong>{{ app()->isLocale('en') ? $diverse_expense->category->label_en : $diverse_expense->category->label_dr }}</strong>
                                    </p>
                            </div>
                            ...
                            <div class="col-lg-6 m-form__group-sub">
                                ...
                                {{__('finance.dSubject')}}</label>
                                    <p><strong>{{ $diverse_expense->reason }}</strong></p>
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 m-form__group-sub">
                                ...
                                <p><strong>{{__("finance.{$diverse_expense->type}")}}</strong></p>
                            </div>

                            <div class="col-lg-6 m-form__group-sub">
                                <label class="form-control-label">
                                {{__('reception.pay_date')}}</label>
                                <p><strong>{{ $diverse_expense->spend->payment_date }}</strong></p>
                            </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6 m-form__group-sub">
                                ...
                                <p><strong>{{ $diverse_expense->spend->amount }} {{ app()->isLocale('en') ? $diverse_expense->spend->currency->label_en : $diverse_expense->spend->currency->label_dr}}</strong></p>
                            </div>
                            ...
                            <div class="col-lg-6 m-form__group-sub">
                                ...
                                <p><strong>{{ app()->isLocale('en') ? $diverse_expense->spend->currency->label_en : $diverse_expense->spend->currency->label_dr}}</strong></p>
                            </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-12 m-form__group-sub">
                                ...
                                <p><strong>{{ $diverse_expense->spend->remitter }}</strong></p>
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-12 m-form__group-sub">
                                ...
                                <textarea name="description" cols="30" rows="10"
                                    class="form-control m-input">{{ $diverse_expense->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
