...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('diverse-income.store') }}" id="save-form" enctype="multipart/form-data" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                {{ csrf_field() }}
                <!--begin: Form Body -->
                <div class="m-portlet__body">
                    <div class="row">
                        <div class="col-xl-10 offset-xl-1 col-md-10 offset-md-1">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <input type="text" name="subject" required class="form-control m-input" value="{{ old('subject') }}" placeholder="">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6 m-form__group-sub">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-12 m-form__group-sub">
                                    ...
                                    <input type="text" name="recipient" required class="form-control m-input" value="{{ old('recipient', auth()->user()->name_dr) }}" placeholder="">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
