        ...
        <div class="m-portlet__body">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                        ...
                        <a href="{{ route('diverse-income.filter') }}" class="btn btn-secondary">
                        ...
                        <div class="m-separator m-separator--dashed d-xl-none"></div>
                            <a class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air"
                                      href="{{ route('diverse-income.create') }}">
            ...
            <table class="table m-table m-table--head-separator-primary">
                ...
                <tbody>
                    ...
                    <td>
                        {{ $income->profit->amount }}
                        {{ app()->getLocale() == 'en' ? $income->profit->currency->label_en : $income->profit->currency->label_dr }}
                    </td>
                    <td>{{ $income->profit->payment_date }}</td>
                    ...
                    <td>
                        <a href="#" onclick="deleteData('{{  route('diverse-income.destroy', $income->id) }}', event)"> <i
                                    class="text-danger flaticon-delete-2"></i></a>
                            &nbsp;
                        <a href="{{ route('diverse-income.edit', [$income->id]) }}">
                            <i class="flaticon-edit"></i>
                        </a>
                        &nbsp;
                        <a href="{{ route('diverse-income.show', [$income->id]) }}">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var search = $('#quick-search').select2({
            ...
            ajax: {
                url: "{{ route('diverse-income.search') }}",
                dataType: 'json',
                type: "get",
                data: function(term) {
                    return term;
        ...
        search.on("change", function(e) {
            ...
            window.location.href = '{{ route("diverse-income.show", [null]) }}' + '/' + object.id;
        });
    });
