...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ url('/admin/role/' . $role->id) }}" id="save-form"
                        ...
                        <div class="col-xl-10 offset-xl-1 col-md-10 offset-md-1">
                            ...
                            <div class="m-form__section m-form__section--first">
                                <div class="form-group m-form__group row">
                                    ...
                                    <input type="text" ngModel name="name" value="{{$role->name}}" required class="form-control m-input">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">* {{__('admin.adm_EnName')}}</label>
                                        <input type="text" ngModel name="label_en"  value="{{$role->label_en}}" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">* {{__('admin.adm_FrName')}}</label>
                                        <input type="text" ngModel name="label_dr" value="{{$role->label_dr}}" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
