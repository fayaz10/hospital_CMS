                ...
                <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark ">
                    <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                        <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
                            <select class="form-control m-input m-input--air border-primary" onchange="this.value ? window.location.href = '{{ url('/') }}' + '/' + this.value : null;">
                                <option>&nbsp; &nbsp;&nbsp;</option>
                                @foreach($modules as $module)
                                    <option value="{{ $module->path }}"
                                            {{ $module->path == (Request::is($module->path) || Request::is($module->path . '/*')) ? 'selected' :'' }} >
                                        {{ \App::getLocale() == 'en' ? $module->label_en : $module->label_dr }} &nbsp; &nbsp; &nbsp;
                                        {{-- $module->label_dr --}}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <li class="m-nav__item m-dropdown m-dropdown--large m-dropdown--arrow m-dropdown--align-center m-dropdown--mobile-full-width m-dropdown--skin-light	m-list-search m-list-search--skin-light" m-dropdown-toggle="click" id="m_quicksearch" m-quicksearch-mode="dropdown" m-dropdown-persistent="1">
                                <a href="#" class="m-nav__link m-dropdown__toggle">
                                    <span class="m-nav__link-icon" style="padding:5px">
                                        ...
                                        <!-- <img src="{{ asset('/assets/app/media/img/flags/uk.svg') }}" alt=""> -->
                                    </span>
                                </a>
                                <div class="m-dropdown__wrapper">
                            ...
                            <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
                                <a href="#" class="m-nav__link m-dropdown__toggle">
                                    <span class="m-topbar__userpic">
                                        <img 
                                            alt="Prof"
                                            src="{{ file_exists(auth()->user()->img_path) ? asset(auth()->user()->img_path) : url('assets/app/media/img/users/user4.jpg') }}" 
                                            class="m--img-rounded m--marginless" alt="" />
                                    </span>
                                    <span class="m-topbar__username m--hide">{{ \App::getLocale() == 'en' ? auth()->user()->name : auth()->user()->name_dr }}</span>
                                </a>
                                <div class="m-dropdown__wrapper">
                                        ...
                                        <div class="m-dropdown__header m--align-center" style="background: url({{asset('assets/app/media/img/misc/user_profile_bg.jpg')}}); background-size: cover;">
                                            <div class="m-card-user m-card-user--skin-dark">
                                                ...
                                                <div class="m-card-user__details">
                                                    ...
                                                    {{ \App::getLocale() == 'en' ? auth()->user()->name : auth()->user()->name_dr }}
                                                    </span>
                                            ...
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="{{ route('profile', [encrypt(auth()->id())]) }}" class="m-nav__link">
                                                            <i class="m-nav__link-icon flaticon-profile-1"></i>
                                                            <span class="m-nav__link-title">
                                                                <span class="m-nav__link-wrap">
                                                                    <span class="m-nav__link-text">{{__('profile.prfile')}}</span>
