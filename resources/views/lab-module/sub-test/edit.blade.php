...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('sub-test.update', [$sub_test->id]) }}" id="save-form" enctype="multipart/form-data"
                            ...
                            <div class="m-form__section m-form__section--first">
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12 m-form__group-sub">
                                        ...
                                        <input type="text" value="{{ $sub_test->name }}" name="name" required
                                        ...
                                        <label class="form-control-label">
                                            ...
                                            <select class="form-control m-input" name="tests[]" id="doctor" multiple>
                                                @foreach(\App\Models\LabModule\Test::all() as $test)
                                                    <option value="{{ $test->id }}" {{ in_array($test->id, $tests) ? 'selected' : '' }}>
                                                        {{ $test->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12 m-form__group-sub">
                                        ...
                                        <textarea name="range" rows="10" class="form-control">{{ $sub_test->range }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
