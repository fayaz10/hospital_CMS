...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('test.update', [$test->id]) }}" id="save-form" enctype="multipart/form-data"
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="text" value="{{ $test->price }}" name="test_price"
                                            class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="currency_id">
                                            ...
                                            <option value="{{ $type->id }}" {{$type->id==$test->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="text" value="{{ $test->duration }}" name="test_duration"
                                            class="form-control m-input" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12 m-form__group-sub">
                                        ...
                                        <textarea name="detailesDr" rows="5" class="form-control">{{$test->description_dr}}</textarea>
                                    </div>
                                </div>
