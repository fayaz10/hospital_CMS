                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"> {{__('reception.pat_record')}} {{__('lab.lab_experiment')}}</label>
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="exp_record_no" data-sortable="true">
                            {{__('reception.pat_record')}} {{__('lab.lab_experiment')}}
                        </th>
                ...
                success: function (data) {
                    ...
                    data.forEach(function (arrayItem) {
                        output.push({
                            ...
                            "status": arrayItem.profit.is_approved == 1 ? "{{__('global.received')}}" : "{{__('global.pending')}}" ,
