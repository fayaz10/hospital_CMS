                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">{{__('finance.dSubject')}}</label>
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">
                                    {{__('pharmacist.pre_patientRecord')}}
                                </label>
                                <div class="input-group m-input-group">
                                    <div class="input-group-prepend">
            ...
            <table class="table m-table m-table--head-separator-primary" id="bootstrap-table" data-show-export="true" data-show-print="true" data-pagination="true" data-show-columns="true">
                <thead>
                    <tr>
                        ...
                        <th data-field="subject" data-sortable="true">{{__('finance.dSubject')}}</th>
                        <th data-field="type" data-sortable="true">{{__('finance.dType')}}</th>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(function(arrayItem, i) {
                        typeLabel = arrayItem.type == 'fixed' ? '{{ __("finance.fixed") }}' : '{{ __("finance.variant") }}';
                        output.push({
                            "no": ++i,
                            ...
                            "operation": "<a href=\'{{ route('din.show', ['']) }}" + "/" + arrayItem.id + "\'<i class='flaticon-eye'></i></a>"
                        });
                    });
