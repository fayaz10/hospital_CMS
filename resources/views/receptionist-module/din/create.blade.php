...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('din.store') }}" id="save-form" enctype="multipart/form-data"
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"> <span class="text-danger">*
                                    </span>{{__('finance.dCategory')}}</label>
                            ...
                            <div class="col-lg-3 m-form__group-sub">
                                <label class="form-control-label"><span class="text-danger">*
                                    </span>{{__('finance.dSubject')}}</label>
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4 m-form__group-sub">
                                ...
                                <input type="number" name="amount" required class="form-control m-input"
                                    value="{{ old('amount') }}" id="amount" onchange="total()">
                                <span class="m-form__help text-primary" id="total">{{__('global.with_tax')}} </span>
                            </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3 m-form__group-sub">
                                ...
                                <input type="text" name="dossier_no" class="form-control m-input"
                                    value="{{ old('dossier_no') }}" placeholder="">
                            </div>
