...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
            ...
            <div class="m-portlet__head-wrapper">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        {{ __('reception.docy_edit')}}
                        </h3>
                    </div>
                </div>
                <div class="m-portlet__head-tools">
                    <a href="{{ route('doctor.index') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('doctor.update', [$doctor->id]) }}" id="save-form" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-xl-10 offset-xl-1 col-md-10 offset-md-1">
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <h3 class="m-form__heading-title">{{ __('reception.docy_edit') }}</h3>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><i class="text-danger">*</i> {{ __('reception.docy_name') }}</label>
                                        <input type="text" value="{{ $doctor->first_name }}" name="first_name" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><i class="text-danger">*</i> {{__('reception.docy_surname')}}</label>
                                        <input type="text" value="{{ $doctor->last_name }}" name="last_name" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <input type="text" value="{{ $doctor->specialist }}" name="specialist" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><i class="text-danger">*</i>{{__('reception.docy_fees')}}</label>
                                        <input type="number" value="{{ $doctor->visit_fee }}" name="visit_fee" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">{{__('reception.docy_currency')}}</label>
                                        <select class="form-control m-input" name="currency_id">
                                                @foreach(\App\Models\FinanceModule\Currency::all() as $type)
                                                    <option value="{{ $type->id }}" {{ $doctor->currency_id == $type->id ? 'selected' : null }} >
                                ...
                                <div class="col-lg-6">
                                        <label class="form-control-label"><i class="text-danger">*</i>{{__('reception.docy_email')}}</label>
                                        <input type="text" name="email" require class="form-control" value="{{ $doctor->email }}">
                                    </div>
                                    </div>
                                <div class=" form-group m-form__group row">
                                    <div class="col-lg-12">
