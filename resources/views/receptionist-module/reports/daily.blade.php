                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8 m-form__group-sub mt-3">
                                ...
                                <select class="form-control m-input multiple" name="approver_id[]">
                                    ...
                                    <option value="{{ $user->id }}" {{ $user->id == auth()->id() ? 'selected' : null }}>
                            ...
                            <div class="col-lg-6 m-form__group-sub mt-3">
                                ...
                                <div class="input-group m-input-group">
                                    <input type="date" value="{{date('Y-m-d')}}" name="from_date" class="form-control m-input"
                                        placeholder="">
            ...
            <div class="m-widget29">
                <div class="m-widget_content">
                    ...
                    <div class="m-widget_content-items">
                        ...
                        <div class="m-widget_content-item">
                            <span>{{__('global.refund_notes')}}</span>
                        ...
                        <div class="m-widget_content-item">
                            <span>{{__('global.total_checkout')}}</span>
