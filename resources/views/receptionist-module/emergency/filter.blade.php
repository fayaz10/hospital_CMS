            ...
            <table class="table m-table m-table--head-separator-primary" id="bootstrap-table" data-show-export="true" data-show-print="true" data-pagination="true" data-show-columns="true">
                <thead>
                    <tr>
                        ...
                        <th data-field="reason" data-sortable="true">{{__('global.reason')}}</th>
                        <th data-field="patient_name" data-sortable="true">{{__('reception.pat_name')}}</th>
                ...
                success: function(data) {
                    ...
                    data.forEach(function(arrayItem, i) {
                        output.push({
                            ...
                            "operation": "<a href=\'{{ route('emergency.show', [null]) }}" + "/" + arrayItem.id + "\'<i class='flaticon-eye'></i></a>"
                        });
                    });
