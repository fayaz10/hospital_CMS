...
@section('content')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">مادیول کورس</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text">لست صنف ها </span>
                        </a>
                    </li>
                    <!-- <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                ...
                <table class="table m-table m-table--head-separator-primary">
                    ...
                    @foreach($courses as $course)
                        ...
                        <tr>
                            <td>{{ ++$loop->index }}</td>
                            <td>{{ $course->name }}</td>
                            <td>{{ $course->label_dr }}</td>
                            <td>{{ $course->label_en }}</td>
                            <td>{{ $course->students_count }}</td>
                            <td>{{ $course->subjects_count }}</td>
                            <td><a href="{{ route('course.edit', $course->id) }}"> <i class="fa fa-edit "
                                                                                      style="color:green"></i></a>&nbsp;&nbsp;
                                <a href="{{ route('course.show', $course->id) }}"> <i class="fa fa-eye"></i></a>&nbsp;&nbsp;
                                {{-- <a href="#" data-toggle="modal" data-target="#m_modal_1"> <i class="fa fa-trash" style="color:red"></i></a></td> --}}
