                            ...
                            <!--Student Information -->
                                <div class="m-form__section m-form__section--first">
                                    <div class="m-form__heading ">
                                        <h3 class="m-form__heading-title">مشخصات مضمون</h3>
                                    </div>
                                    <div class="row form-group m-form__group ">
                                        <div class="col-lg-4">
                                                <label class="form-control-label"><span class="text-danger">* </span>مضمون(Unique): </label>
                                                <input type="text" name="name" required
                                                       class="form-control m-input">
                                        </div>
                                        <div class="col-lg-4">
                                                <label class="form-control-label"><span class="text-danger">* </span>نام مضمون(دری): </label>
                                                <input type="text" name="label_dr" required
                                                       class="form-control m-input">
                                        </div>
                                        <div class="col-lg-4">
                                                <label class="form-control-label"><span class="text-danger">* </span>مضمون(English): </label>
