...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('prescription.store') }}" id="save-form" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                {{ csrf_field() }}
                <!--begin: Form Body -->
                <div class="m-portlet__body">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 ">
                            ...
                            <div class="m-form__section m-form__section--first">
                                <div class="m-form__heading">
                                    <h3 class="m-form__heading-title">{{__('pharmacist.pre_newPresInfo')}}</h3>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="date" required value="{{ old('date', date('Y-m-d')) }}" name="date" required class="form-control m-input" placeholder="">
                                    </div>

                                    <div class="col-lg-3 m-form__group-sub">
                                        <label class="form-control-label"><span class="text-danger">* </span> {{__('global.paymentType')}}</label>
                                        <select class="form-control m-input" id="payment_type" name="type">
                                            <option value="now">{{__('global.now')}}</option>
                                            <option value="later">{{__('global.payLater')}}</option>
                                        </select>
                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="thanks" data-dismiss="modal">{{ __('pharmacist.pre_thanks') }}</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $('#save-button').click(function() {
        ...
        if(paymentType == 'later')
            form.attr('action', '{{ route("surpres.store") }}')
