...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('surpres.update', $surpre->id) }}" id="save-form" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                {{ csrf_field() }}
                @method('PUT')
                <!--begin: Form Body --> 
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-8 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="patient_id" id="patient">
                                            <option value="{{ optional($surpre->patient)->id }}">
                                                ({{ optional($surpre->patient)->name }}) {{ optional($surpre->patient)->record_no }}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 m-form__group-sub">
                                        <label class="form-control-label"><span class="text-danger">* </span> {{__('pharmacist.pre_issueDate')}}</label>
                                        <input type="date" required value="{{ $surpre->date }}" name="date" required class="form-control m-input" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    <table class="table m-table m-table--head-separator-primary">
                                        ...
                                        <tbody id="tbody">
                                            @foreach($surpre->medicines as $medicine)
                                            <tr>
