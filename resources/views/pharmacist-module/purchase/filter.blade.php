            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        {{__('global.filter')}} 
                        {{__('pharmacist.side_medBuyTitle')}} 
                    </h3>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">{{__('pharmacist.med_import')}}</label>
                                <input type="text" value="" name="suppliers" class="form-control m-input" placeholder="">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">
                                    {{__('pharmacist.med_purchase_date')}}
                                </label>
            ...
            <table class="table m-table m-table--head-separator-primary" id="bootstrap-table" data-show-export="true"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="suppliers" data-sortable="true">{{__('pharmacist.med_import')}}</th>
                        <th data-field="purchase_date" data-sortable="true">{{__('pharmacist.med_purchase_date')}}</th>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $('#save-form').on('submit', function (e) {
            ...
            //submit the form
            $.ajax({
                url: '{{ route("medicine-purchase.filter") }}',
                type: "GET",
                data: data,
                dataType: "json",
