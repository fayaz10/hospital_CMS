...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="{{ route('medicine.update', [$medicine->id]) }}" id="save-form" enctype="multipart/form-data" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                {{ csrf_field() }}
                @method('put')
                <!--begin: Form Body -->
                <div class="m-portlet__body">
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <input type="text" value="{{ $medicine->name }}" name="name" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><i class="text-danger">*</i> {{__('pharmacist.med_milligram')}}</label>
                                        <input type="number" value="{{ $medicine->milligram}}" name="milligram" required class="form-control m-input" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><i class="text-danger">*</i> {{__('pharmacist.med_company')}}</label>
                                        <input type="text" value="{{$medicine->company}}" name="company" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="type_id">
                                            ...
                                            <option value="{{ $type->id }}" {{ $medicine->type_id == $type->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="unit_id">
                                            ...
                                            <option value="{{ $unit->id }}" {{ $medicine->unit_id == $unit->id ? 'selected' : '' }}> {{ app()->isLocale('en') ? $unit->label_en : $unit->label_dr }} ({{ $unit->name }})</option>
                                            @endforeach
                                        </select>
                                    </div>

                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">{{__('pharmacist.med_expire_date')}}</label>
                                        <input type="date" value="{{ optional($medicine->expire_date)->format('Y-m-d') }}" name="expire_date" class="form-control m-input">
                                    </div>
