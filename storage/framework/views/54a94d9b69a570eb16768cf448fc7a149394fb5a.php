...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-subheader__title m-subheader__title--separator">
                            <?php echo e(__('lab.lab_edittest')); ?>
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(route('test.update', [$test->id])); ?>" id="save-form" enctype="multipart/form-data"
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="text" value="<?php echo e($test->name); ?>" name="test_name" required
                                    ...
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="text" value="<?php echo e($test->label_dr); ?>" name="test_nameDr"
                                            class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-4 m-form__group-sub">
                                        <label class="form-control-label"><?php echo e(__('lab.lab_testEn')); ?></label>
                                        <input type="text" value="<?php echo e($test->label_en); ?>" name="test_nameEn"
                                            class="form-control m-input" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="text" value="<?php echo e($test->price); ?>" name="test_price"
                                            class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="currency_id">
                                            ...
                                            <option value="<?php echo e($type->id); ?>" <?php echo e($type->id==$test->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="text" value="<?php echo e($test->duration); ?>" name="test_duration"
                                            class="form-control m-input" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12 m-form__group-sub">
                                        ...
                                        <textarea name="detailesDr" rows="5" class="form-control"><?php echo e($test->description_dr); ?></textarea>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/lab-module/test/edit.blade.php ENDPATH**/ ?>