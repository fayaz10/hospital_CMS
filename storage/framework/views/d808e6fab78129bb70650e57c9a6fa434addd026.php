    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text"><?php echo e(__('global.create')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            <?php echo e(__('finance.eNewDiverIncome')); ?>
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(route('diverse-expense.store')); ?>" id="save-form" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <select class="form-control m-input" name="category_id" id="category">
                                        <?php $__currentLoopData = \App\Models\FinanceModule\DiverseCategory::where('type', 'expense')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-lg-6 m-form__group-sub">
                                    <label class="form-control-label"><span class="text-danger">* </span><?php echo e(__('finance.reason')); ?></label>
                                    <input type="text" name="reason" required class="form-control m-input" value="<?php echo e(old('reason')); ?>" placeholder="">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6 m-form__group-sub">
                                    <label class="form-control-label">
                                        <span class="text-danger">* </span><?php echo e(__('finance.eType')); ?>

                                    </label>
                                    <select class="form-control m-input" name="type">
                                        <?php $__currentLoopData = \App\Models\FinanceModule\DiverseExpense::getTypeValues(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-12 m-form__group-sub">
                                    ...
                                    <input type="text" name="remitter" required class="form-control m-input" value="<?php echo e(old('remitter', auth()->user()->name_dr)); ?>" placeholder="">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/finance-module/diverse-expense/create.blade.php ENDPATH**/ ?>