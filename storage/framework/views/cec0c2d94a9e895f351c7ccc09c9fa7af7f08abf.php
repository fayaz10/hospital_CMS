    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text"><?php echo e(__('global.filter')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        ...
                        <?php echo e(__('finance.sideDiverseExpense')); ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"><?php echo e(__('finance.reason')); ?></label>
                                <input type="text" name="reason" class="form-control m-input" value="">
                            </div>
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">
                                    <?php echo e(__('finance.eType')); ?>
            ...
            <table class="table m-table m-table--head-separator-primary" id="bootstrap-table" data-show-export="true" data-show-print="true" data-pagination="true" data-show-columns="true">
                <thead>
                    <tr>
                        ...
                        <th data-field="reason" data-sortable="true"><?php echo e(__('finance.reason')); ?></th>
                        <th data-field="type" data-sortable="true"><?php echo e(__('finance.eType')); ?></th>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $('#save-form').on('submit', function(e) {
            ...
            //submit the form
            $.ajax({
                url: '<?php echo e(route("diverse-expense.filter")); ?>',
                type: "GET",
                data: data,
                dataType: "json",
                success: function(data) {
                    ...
                    data.forEach(function(arrayItem, i) {
                        output.push({
                            ...
                            "operation": "<a href=\'<?php echo e(route('diverse-expense.show', [null])); ?>" + "/" + arrayItem.id + "\'<i class='flaticon-eye'></i></a>"
                        });
                    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/finance-module/diverse-expense/filter.blade.php ENDPATH**/ ?>