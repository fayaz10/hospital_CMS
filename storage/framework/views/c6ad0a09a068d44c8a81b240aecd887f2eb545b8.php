...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(route('prescription.update', $prescription->id)); ?>" id="save-form" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="patient_id" id="patient">
                                            <option value="<?php echo e($prescription->patient->id); ?>">
                                                (<?php echo e($prescription->patient->name); ?>) <?php echo e($prescription->patient->record_no); ?>
                                        ...
                                        <select class="form-control m-input" name="doctor_id" id="doctor">
                                            <option value=""></option>
                                                <?php $__currentLoopData = \App\Models\Receptionist\Doctor::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($doctor->id); ?>" <?php echo e($prescription->doctor_id == $doctor->id ? 'selected' : null); ?>>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4 m-form__group-sub">
                                        ...
                                        <input type="date" required value="<?php echo e($prescription->date); ?>" name="date" required class="form-control m-input" placeholder="">
                                    </div>

                                    <div class="col-lg-8 m-form__group-sub">
                                        <label class="form-control-label"><?php echo e(__('pharmacist.pre_diagnosis')); ?></label>
                                        <textarea name="diagnosis" class="form-control"><?php echo e($prescription->diagnosis); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    <table class="table m-table m-table--head-separator-primary">
                                        ...
                                        <tbody id="tbody">
                                            <?php $__currentLoopData = $prescription->medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/pharmacist-module/prescription/edit.blade.php ENDPATH**/ ?>