            ...
            <div class="m-portlet__body">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                            ...
                            <a class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air"
                                      href="<?php echo e(route('sub-test.create')); ?>">
                ...
                <table class="table m-table m-table--head-separator-primary">
                    ...
                    <tr>
                        ...
                        <th><?php echo e(__('global.original_test_name')); ?></th>
                        <th><?php echo e(__('pharmacist.r_range')); ?></th>
                    ...
                    <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <tr>
                            ...
                            <td><?php echo implode(' <span class="text-info la la-minus"></span> ', optional($test->tests)->pluck('name', 'id')->toArray()); ?></td>
                            <td>
                                <pre><?php echo $test->range; ?></pre>
                            </td>
                            <td>
                                <a href="<?php echo e(route('sub-test.edit', $test->id)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/lab-module/sub-test/index.blade.php ENDPATH**/ ?>