...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(route('sub-test.update', [$sub_test->id])); ?>" id="save-form" enctype="multipart/form-data"
                            ...
                            <div class="m-form__section m-form__section--first">
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12 m-form__group-sub">
                                        ...
                                        <input type="text" value="<?php echo e($sub_test->name); ?>" name="name" required
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12 m-form__group-sub">
                                        <label class="form-control-label">
                                            <?php
                                                $tests = optional($sub_test->tests)->pluck('id')->toArray();
                                                // dd($tests);
                                            ?>
                                            ...
                                            <select class="form-control m-input" name="tests[]" id="doctor" multiple>
                                                <?php $__currentLoopData = \App\Models\LabModule\Test::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($test->id); ?>" <?php echo e(in_array($test->id, $tests) ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12 m-form__group-sub">
                                        ...
                                        <textarea name="range" rows="10" class="form-control"><?php echo e($sub_test->range); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/lab-module/sub-test/edit.blade.php ENDPATH**/ ?>