            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                        ...
                        <a class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air" href="<?php echo e(url('/admin/role/create')); ?>">
            ...
            <table class="table m-table m-table--head-separator-primary">
                <thead class="table-inverse">
                    <tr>
                        ...
                        <th><?php echo e(__('global.code')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e(($roles->currentPage() == 0 ? 1 :$roles->currentPage() - 1) * $roles ->perPage() + $key + 1); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/system-admin/role/index.blade.php ENDPATH**/ ?>