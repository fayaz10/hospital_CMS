...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(url('/admin/role/' . $role->id)); ?>" id="save-form"
                        ...
                        <div class="col-xl-10 offset-xl-1 col-md-10 offset-md-1">
                            ...
                            <div class="m-form__section m-form__section--first">
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12">
                                        <label class="form-control-label">* <?php echo e(__('global.code')); ?></label>
                                    <input type="text" ngModel name="name" value="<?php echo e($role->name); ?>" required class="form-control m-input">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">* <?php echo e(__('admin.adm_EnName')); ?></label>
                                        <input type="text" ngModel name="label_en"  value="<?php echo e($role->label_en); ?>" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">* <?php echo e(__('admin.adm_FrName')); ?></label>
                                        <input type="text" ngModel name="label_dr" value="<?php echo e($role->label_dr); ?>" required class="form-control m-input"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12">
                                        ...
                                        <select name="permissions[]" id="roles" multiple class="form-control m-input">
                                            <?php $__currentLoopData = \App\Models\SystemAdmin\Permission::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/system-admin/role/edit.blade.php ENDPATH**/ ?>