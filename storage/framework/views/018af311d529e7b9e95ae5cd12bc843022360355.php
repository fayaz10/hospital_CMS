...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(route('medicine.store')); ?>" id="save-form" enctype="multipart/form-data" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><i class="text-danger">*</i> <?php echo e(__('pharmacist.med_milligram')); ?></label>
                                        <input type="number" value="<?php echo e(old('milligram')); ?>" name="milligram" required class="form-control m-input" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><i class="text-danger">*</i> <?php echo e(__('pharmacist.med_company')); ?></label>
                                        <input type="text" value="<?php echo e(old('company')); ?>" name="company" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="unit_id">
                                            ...
                                            <option value="<?php echo e($unit->id); ?>" <?php echo e(old('unit_id') == $unit->id ? 'selected' : ''); ?>> <?php echo e(app()->isLocale('en') ? $unit->label_en : $unit->label_dr); ?> (<?php echo e($unit->name); ?>)</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><span class="text-danger">* </span> <?php echo e(__('تاریخ انقضا')); ?></label>
                                        <input type="date" required value="<?php echo e(old('expire_date', date('Y-m-d'))); ?>" name="expire_date" required class="form-control m-input" placeholder="">
                                    </div>
                                </div>

                                <div class="m-form__heading">
                                    <h3 class="m-form__heading-title"> <?php echo e(__('pharmacist.med_excistNow')); ?></h3>
                                </div>

                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4 m-form__group-sub">
                                        <label class="form-control-label"><?php echo e(__('pharmacist.med_excistNow')); ?></label>
                                        <input type="number" name="quantity" value="<?php echo e(old('quantity')); ?>" class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-4 m-form__group-sub">
                                        <label class="form-control-label"><?php echo e(__('pharmacist.med_price')); ?></label>
                                        <input type="number" name="unit_price" value="<?php echo e(old('unit_price')); ?>" class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-4 m-form__group-sub">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/pharmacist-module/medicine/create.blade.php ENDPATH**/ ?>