                    ...
                    <div class="col-xl-12 col-md-12 ">
                        ...
                        <div class="m-form__section m-form__section--first">
                            ...
                            <div class="m-form__heading ">
                                <h3 class="m-form__heading-title"> <?php echo e(__('finance.incomeInfo')); ?></h3>
                            </div>

                            <div class="row form-group m-form__group ">
                                <div class="col-lg-4">
                                    <label class="form-control-label"><?php echo e(__('finance.incSection')); ?> </label>
                                    <p><strong><?php echo e(__('finance.'.strtolower(basename($income->profitable_type, '\\')))); ?></strong>
                                    </p>
                                </div>
                                <div class="col-lg-4">
                                    <label class="form-control-label"><?php echo e(__('finance.paymentDate')); ?></label>
                                    <p><strong><?php echo e($income->payment_date); ?></strong></p>
                                </div>
                                <div class="col-lg-4">
                                    <label class="form-control-label"><?php echo e(__('lab.lab_expCreatedAt')); ?></label>
                                    <p><strong><?php echo e($income->created_at->format('Y-m-d g:i A')); ?></strong></p>
                                </div>
                            </div>
                            <div class="row form-group m-form__group ">
                                <div class="col-lg-4">
                                    <label class="form-control-label"> <?php echo e(__('finance.amount')); ?> </label>
                                    <p><strong>
                                            <?php echo e($income->amount); ?>

                                            <?php echo e(app()->isLocale('en') ? $income->currency->label_en : $income->currency->label_dr); ?>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <p><strong>
                                            <?php echo e(app()->isLocale('en') ? $income->registrar->name : $income->registrar->name_dr); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyWebs\hosys\hosys\hosys\resources\views/finance-module/income/show.blade.php ENDPATH**/ ?>