            ...
            <div class="m-form m-form--label-align-right">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-8 order-1 order-xl-2 m--align-right">
                        ...
                        <?php
                            $status = $surpre->approve()->latest()->first();
                        ?>
                        <?php if($status && $status->is_approved === null): ?>
                            <a href="#"
                                class="btn m-btn btn-info m-loader m-loader--light m-loader--left">
                                <span><?php echo e(__('global.sent2Approve')); ?></span> </span> </a>
                        <?php elseif($status && $status->is_approved === 0): ?>
                            <a href="<?php echo e(route('surpres.sent2Approve', [$surpre->id])); ?>" 
                                onclick="return confirm('<?php echo e(__('global.irreversable')); ?>')"
                                class="btn btn-info">
                                <span> <i class="la la-share"></i> <span><?php echo e(__('global.sent2ApproveAgain')); ?></span> </span> </a>
                        <?php elseif($status && $status->is_approved === 1): ?>
                            <a href="#" 
                                class="btn btn-info">
                                <span> <i class="la la-share"></i> <span><?php echo e(__('global.received')); ?></span> </span> </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('surpres.sent2Approve', [$surpre->id])); ?>" 
                                onclick="return confirm('<?php echo e(__('global.irreversable')); ?>')"
                                class="btn btn-info">
                                <span> <i class="la la-share"></i> <span><?php echo e(__('global.sent2Approve')); ?></span> </span> </a>
                        <?php endif; ?>

                        
                        <div class="m-separator m-separator--dashed d-xl-none"></div>
                        <a href="<?php echo e(route('surpres.print', [$surpre->id])); ?>" class="btn btn-secondary">
                        ...
                        <div class="m-separator m-separator--dashed d-xl-none"></div>
                        <a href="<?php echo e(route('surpres.edit', [$surpre->id])); ?>" class="btn btn-secondary">
                        ...
                        <div class="m-form__section m-form__section--first">
                            ...
                            <div class="row form-group m-form__group ">
                                <div class="col-lg-3">
                                    ...
                                    <p><strong><?php echo e(optional($surpre->patient)->name); ?></strong></p>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('reception.vis_record')); ?></label>
                                    <p><strong><?php echo e(optional($surpre->patient)->record_no); ?></strong></p>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('reception.vis_doctors')); ?></label>
                                    <p><strong><?php echo e(optional($surpre->doctor)->name); ?></strong></p>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('global.issue_date')); ?> </label>
                                    <p><strong><?php echo e($surpre->date); ?></strong></p>
                                </div>
                            </div>
                            ...
                            <div class="row form-group m-form__group ">
                                <div class="col-lg-3">
                                    ...
                                    <p><strong>
                                            <?php echo e($surpre->profit->amount); ?>

                                            <?php echo e(app()->isLocale('en') ? $surpre->profit->currency->label_en : $surpre->profit->currency->label_dr); ?>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <p><strong>
                                            <?php echo e($surpre->profit->taxes); ?>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <p><strong>
                                            <?php echo e($surpre->profit->totalAmount); ?>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <p><strong>
                                            <?php echo e(app()->isLocale('en') ? $surpre->profit->registrar->name : $surpre->profit->registrar->name_dr); ?>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $surpre->medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('stock-out.store')); ?>" id="add-form" method="post">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="prescription_id" value="<?php echo e($surpre->id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/pharmacist-module/surpres/show.blade.php ENDPATH**/ ?>