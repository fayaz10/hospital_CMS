...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            <?php echo e(__('profile.user_edit')); ?>
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(url('/admin/user/' . $user->id)); ?>" id="save-form" enctype="multipart/form-data" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" value="<?php echo e($user->email); ?>" name="email" required class="form-control m-input">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">* <?php echo e(__('admin.adm_EnName')); ?></label>
                                        <input type="text" value="<?php echo e($user->name); ?>" name="name" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label">* <?php echo e(__('admin.adm_FrName')); ?></label>
                                        <input type="text" value="<?php echo e($user->name_dr); ?>" name="name_dr" required class="form-control m-input" placeholder="">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/system-admin/user/edit.blade.php ENDPATH**/ ?>