...
<div class="m-content">
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            <?php echo e(__('reception.pat_edit')); ?>
        ...
        <div class="m-portlet__body">
            ...
            <form action="<?php echo e(route('patient.update', [$patient->id])); ?>" id="save-form" enctype="multipart/form-data" class="m-form m-form--label-align-left m-form--state col-12" method="post">
                        ...
                        <div class="col-xl-10 offset-xl-1 col-md-10 offset-md-1">
                            ...
                            <div class="m-form__section m-form__section--first">
                                <div class="m-form__heading">
                                    <h3 class="m-form__heading-title"><?php echo e(__('reception.pat_edit')); ?></h3>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><span class="text-danger">* </span><?php echo e(__('reception.pat_Fullname')); ?></label>
                                        <input type="text" value="<?php echo e($patient->name); ?>" name="name" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <select class="form-control m-input" name="sex">
                                            <option value="m" <?php echo e($patient->sex == 'm' ? 'selected' : ''); ?>>
                                                <?php echo e(__("reception.m")); ?>

                                            </option>
                                            <option value="f" <?php echo e($patient->sex == 'f' ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        ...
                                        <input type="number" value="<?php echo e($patient->age); ?>" name="age" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><?php echo e(__('reception.pat_phone')); ?></label>
                                        <input type="number" value="<?php echo e($patient->phone_no); ?>" name="phone_no" class="form-control m-input" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-6 m-form__group-sub">
                                        <label class="form-control-label"><?php echo e(__('reception.vis_address')); ?></label>
                                        <input type="text" value="<?php echo e($patient->address); ?>" name="address" required class="form-control m-input" placeholder="">
                                    </div>
                                    <div class="col-lg-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/receptionist-module/patient/edit.blade.php ENDPATH**/ ?>