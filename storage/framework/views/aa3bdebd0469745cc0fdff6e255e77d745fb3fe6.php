...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $('#save-form').on('submit', function(e) {
            ...
            //submit the form
            $.ajax({
                url: '<?php echo e(route("diverse-income.filter")); ?>',
                type: "GET",
                data: data,
                dataType: "json",
                success: function(data) {
                    ...
                    data.forEach(function(arrayItem, i) {
                        ...
                        output.push({
                            ...
                            "operation": "<a href=\'<?php echo e(route('diverse-income.show', [null])); ?>" + "/" + arrayItem.id + "\'<i class='flaticon-eye'></i></a>"
                        });
                    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/finance-module/diverse-income/filter.blade.php ENDPATH**/ ?>