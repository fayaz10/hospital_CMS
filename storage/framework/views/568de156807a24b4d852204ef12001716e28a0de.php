                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"> <?php echo e(__('reception.pat_age')); ?></label>
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"><?php echo e(__('reception.vis_cashier')); ?></label>
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"> <?php echo e(__('reception.vis_discount')); ?></label>
                                <div class="input-group m-input-group">
                                    <div class="input-group-prepend">
                                    ...
                                    <select class="form-control m-input" name="discount">
                                        <option value="">
                                            <?php echo e(__('reception.doesntHas')); ?>
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label">
                                    <?php echo e(__('reception.docy_fees')); ?>
            ...
            <table class="table m-table m-table--head-separator-primary" id="bootstrap-table" data-show-export="true"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="phone_no" data-sortable="true"><?php echo e(__('reception.pat_phone')); ?></th>
                        <th data-field="age" data-sortable="true"><?php echo e(__('reception.pat_age')); ?></th>
                        <th data-field="doctorName" data-sortable="true"><?php echo e(__('reception.vis_doctors')); ?></th>
                        <th data-field="visit_fee" data-sortable="true"><?php echo e(__('reception.docy_fees')); ?></th>
                        <th data-field="taxes" data-sortable="true"><?php echo e(__('reception.pay_tax')); ?></th>
                        <th data-field="totalAmount" data-sortable="true"><?php echo e(__('reception.amountOfPayament')); ?>

                        </th>
                        <th data-field="cashierName" data-sortable="true"><?php echo e(__('reception.vis_cashier')); ?></th>
                        <th data-field="discount" data-sortable="true"><?php echo e(__('reception.vis_discount')); ?></th>
                        <th data-field="created_at" data-sortable="true"><?php echo e(__('reception.pat_regdate')); ?></th><th data-field="operation" data-printIgnore="true" ><?php echo e(__('global.view')); ?></th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $('#save-form').on('submit', function (e) {
            ...
            //submit the form
            $.ajax({
                url: '<?php echo e(route("visit.search")); ?>',
                type: "GET",
                data: data,
                dataType: "json",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/receptionist-module/visit/filter.blade.php ENDPATH**/ ?>