                    ...
                    <div class="col-12">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4 m-form__group-sub">
                                ...
                                <input type="text" name="patient_name" class="form-control m-input" value="">
                            </div>
            ...
            <table class="table m-table m-table--head-separator-primary" id="bootstrap-table" data-show-export="true" data-show-print="true" data-pagination="true" data-show-columns="true">
                <thead>
                    <tr>
                        ...
                        <th data-field="reason" data-sortable="true"><?php echo e(__('global.reason')); ?></th>
                        <th data-field="patient_name" data-sortable="true"><?php echo e(__('reception.pat_name')); ?></th>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $('#save-form').on('submit', function(e) {
            ...
            //submit the form
            $.ajax({
                url: '<?php echo e(route("emergency.filter")); ?>',
                type: "GET",
                data: data,
                dataType: "json",
                success: function(data) {
                    ...
                    data.forEach(function(arrayItem, i) {
                        output.push({
                            ...
                            "patient_name": arrayItem.patient_name,
                            ...
                            "operation": "<a href=\'<?php echo e(route('emergency.show', [null])); ?>" + "/" + arrayItem.id + "\'<i class='flaticon-eye'></i></a>"
                        });
                    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/receptionist-module/emergency/filter.blade.php ENDPATH**/ ?>