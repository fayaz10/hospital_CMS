    ...
    <body class="bg-purple">
        ...
        <div class="stars">
            <div class="central-body">
                <h1 style="color:white"><?php echo e(__('global.unauthorized')); ?></h1>
                <h3 style="color:white"><?php echo e(__('global.unauthorized_message')); ?></h3>
                <a href="<?php echo e(url('/')); ?>" class="btn-go-home" target="_blank"><?php echo e(__('global.back_home')); ?></a>
            </div>
            <div class="objects">
                <img class="object_rocket" src="<?php echo e(asset('assets/app/media/img/error/rocket.svg')); ?>" width="40px">
                <div class="earth-moon">
                    <img class="object_earth" src="<?php echo e(asset('assets/app/media/img/error/earth.svg')); ?>" width="100px">
                    <img class="object_moon" src="<?php echo e(asset('assets/app/media/img/error/moon.svg')); ?>" width="80px">
                </div>
                <div class="box_astronaut">
                    <img class="object_astronaut" src="<?php echo e(asset('assets/app/media/img/error/astronaut.svg')); ?>" width="140px">
                </div>
            </div>
...
</html><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/errors/403.blade.php ENDPATH**/ ?>