            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                        ...
                        <div class="m-separator m-separator--dashed d-xl-none"></div>
                        <a href="<?php echo e(route('medicine-purchase.edit', [$medicinePurchase->id])); ?>" class="btn btn-secondary">
                        ...
                        <a class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air" href="<?php echo e(route('medicine-purchase.create')); ?>">
                            <span> <i class="la la-plus"></i> <span><?php echo e(__('global.gol_cret')); ?></span>
                            </span>
                        </a>
                        <div class="m-separator m-separator--dashed d-xl-none"></div>
                    </div>
                    ...
                    <div class="col-xl-12 col-md-12 ">
                        ...
                        <div class="m-form__section m-form__section--first">
                            <div class="m-form__heading ">
                                <h3 class="m-form__heading-title"><?php echo e(__('pharmacist.med_medPurchase')); ?></h3>
                            </div>

                            <div class="row form-group m-form__group ">
                                <div class="col-lg-3">
                                    <label class="form-control-label"><?php echo e(__('pharmacist.med_purchase_date')); ?></label>
                                    <p><strong><?php echo e($medicinePurchase->purchase_date); ?></strong></p>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('pharmacist.med_payment')); ?></label>
                                    <p><strong><?php echo e($medicinePurchase->spend->remitter); ?></strong></p>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('pharmacist.med_indusCompany')); ?></label>
                                    <p><strong><?php echo e($medicinePurchase->suppliers); ?></strong></p>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('pharmacist.med_register')); ?></label>
                                    <p><strong>
                                            <?php echo e(app()->isLocale('en') ? $medicinePurchase->spend->registrar->name : $medicinePurchase->spend->registrar->name_dr); ?>
                            ...
                            <div class="row form-group m-form__group ">
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('pharmacist.med_totalPay')); ?></label>
                                    <p><strong>
                                            <?php echo e($medicinePurchase->spend->amount); ?>

                                            <?php echo e(app()->isLocale('en') ? $medicinePurchase->spend->currency->label_en : $medicinePurchase->spend->currency->label_dr); ?>

                                        </strong></p>
                                </div>
                                <div class="col-lg-3">
                                    <label class="form-control-label"><?php echo e(__('pharmacist.pur_benefits')); ?></label>
                                    <p><strong>
                                            <?php echo e(\App\iSys\Services\IncomeFormatter::toAmount($medicinePurchase->spend->amount, config("iSys.benefits.medicinePurchase", config("iSys.benefits.default")))); ?>
                                ...
                                <div class="col-lg-3">
                                    <label class="form-control-label"><?php echo e(__('pharmacist.pur_withBenefits')); ?></label>
                                    <p><strong>
                                            <?php echo e(\App\iSys\Services\ExpenseHelper::withBenefits($medicinePurchase->spend->amount)); ?>
                                ...
                                <div class="col-lg-3">
                                    <label class="form-control-label"> <?php echo e(__('pharmacist.pre_medicine_quantity')); ?></label>
                                    <p><strong><?php echo e($medicinePurchase->medicines->count()); ?> <?php echo e(__('pharmacist.pres_items')); ?></strong></p>
                                </div>
                            </div>
                            ...
                            <table class="table">
                                <thead class="thead-inverse">
                                    <tr class="h5">
                                        ...
                                        <th> <?php echo e(__('pharmacist.med_indusCompany')); ?></th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $medicinePurchase->medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($medicine->pivot->total_price); ?>
                                        ...
                                        <td>
                                            ...
                                            <?php echo e(\App\iSys\Services\ExpenseHelper::unitPriceWithBenefits($medicine->pivot->total_price, $medicine->pivot->quantity)); ?>

                                            <?php echo e(app()->isLocale('en') ? $medicinePurchase->spend->currency->label_en : $medicinePurchase->spend->currency->label_dr); ?>

                                        </td>
                                        <td>
                                            <button class="btn btn-sm" onclick="event.preventDefault();editPurchaseItem('<?php echo e($medicine->pivot->id); ?>')">
                                                <i class="flaticon-edit-1"></i>
                                            </button>
                                            &nbsp;
                                            <button class="btn btn-sm btn-outline-danger" onclick="event.preventDefault();deleteTestCompletion('<?php echo e($medicine->pivot->id); ?>')">
        ...
        <div class="modal-content">
            ...
            <form action="" id="save-form" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="results" class="form-control-label"><?php echo e(__('pharmacist.pre_medicine_quantity')); ?></label>
                        <input type="number" value="" name="quantity" id="quantity" class="form-control m-input" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="description" class="form-control-label"><?php echo e(__('pharmacist.med_totalPrice')); ?></label>
                        <input type="number" value="" name="total_price" id="total_price" class="form-control m-input" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="experimentor" class="form-control-label"><?php echo e(__('pharmacist.med_price')); ?></label>
                        <span class="form-control">
...
<div class="modal fade" id="m_modal_3" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('purchase-list.store')); ?>" id="add-form" method="post">
                <div class="modal-body">
                    <?php echo e(csrf_field()); ?>

                    <input type="hidden" name="purchase_id" value="<?php echo e($medicinePurchase->id); ?>">
...
<script type="text/javascript">
    ...
    function editPurchaseItem(id) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo e(route("purchase-list.show", [null])); ?>' + '/' + id,
            dataType: 'json',
            success: function(data) {
                ...
                $('#m_modal_4 #save-form').attr('action', '<?php echo e(route("purchase-list.update", [null])); ?>' + '/' + id);
    ...
    function deleteTestCompletion(id) {
        ...
        $('#m_modal_2 #save-form').attr('action', '<?php echo e(route("purchase-list.destroy", [null])); ?>' + '/' + id);
    }
</script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/pharmacist-module/purchase/show.blade.php ENDPATH**/ ?>