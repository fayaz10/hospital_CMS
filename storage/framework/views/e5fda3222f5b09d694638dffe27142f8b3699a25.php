                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4 m-form__group-sub">
                                <label class="form-control-label"> <?php echo e(__('reception.pat_record')); ?> <?php echo e(__('lab.lab_experiment')); ?></label>
                                <input type="number" value="" name="exp_record_no" class="form-control m-input"
                                    placeholder="">
                            </div>
            ...
            <table class="table m-table m-table--head-separator-primary" id="bootstrap-table" data-show-export="true"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="exp_record_no" data-sortable="true">
                            <?php echo e(__('reception.pat_record')); ?> <?php echo e(__('lab.lab_experiment')); ?>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $('#save-form').on('submit', function (e) {
            ...
            //submit the form
            $.ajax({
                url: '<?php echo e(route("experiment.filter")); ?>',
                type: "GET",
                data: data,
                dataType: "json",
                success: function (data) {
                    ...
                    data.forEach(function (arrayItem) {
                        output.push({
                            ...
                            "exp_record_no": arrayItem.record_no,
                            ...
                            "status": arrayItem.profit.is_approved == 1 ? "<?php echo e(__('global.received')); ?>" : "<?php echo e(__('global.pending')); ?>" ,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\db\htdocs\hosys\resources\views/lab-module/experiment/filter.blade.php ENDPATH**/ ?>